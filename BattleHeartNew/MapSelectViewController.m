...
- (void)viewDidLoad {
    ...
    [_mapView setDataWithArr:@[[UIImage imageNamed:@"RedBatScene.png"],[UIImage imageNamed:@"RedBatScene.png"],[UIImage imageNamed:@"RedBatScene.png"]] textArr:@[@"蝙蝠领地",@"忍者？？？",@"幕后主使",@"蝙蝠领地",]];
